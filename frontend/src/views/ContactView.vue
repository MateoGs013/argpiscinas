        ...
        <div class="grid lg:grid-cols-3 gap-14">
          ...
          <div class="lg:col-span-1">
            <div class="sticky top-24 space-y-10">
              <div>
                <h2 class="text-xl font-bold text-neutral-900 mb-4">{{ t('contact.info.title', 'Información de Contacto') }}</h2>
                <p class="text-neutral-500 text-sm leading-relaxed">
                  {{ t('contact.info.description', 'Puedes contactarnos por cualquiera de estos medios o rellenar el formulario y te responderemos en menos de 24 horas.') }}
                </p>
              </div>
              ...
              <div class="space-y-7">
                ...
                <div class="flex items-start space-x-4">
                  <div class="w-10 h-10 bg-green-800 rounded-boutique flex items-center justify-center flex-shrink-0">
          ...
          <div class="lg:col-span-2">
            <div class="bg-white rounded-boutique-lg p-10 border border-neutral-100">
              <h2 class="text-xl font-bold text-neutral-900 mb-8">{{ t('contact.form.title', 'Envíanos un Mensaje') }}</h2>
              
              <div v-if="submitSuccess" class="mb-8 p-5 bg-green-50 border border-green-100 rounded-boutique">
              ...
              <form @submit.prevent="submitForm" class="space-y-6">
                <div class="grid md:grid-cols-2 gap-6">
                  <div>
                    <label for="name" class="block text-xs font-medium text-neutral-600 mb-2 tracking-wide uppercase">
                      Nombre completo *
                    </label>
                    <input 
                      id="name"
                  ...
                  <div>
                    <label for="email" class="block text-xs font-medium text-neutral-600 mb-2 tracking-wide uppercase">
                      Email *
                    </label>
                    <input 
                      id="email"
                ...
                <div class="grid md:grid-cols-2 gap-6">
                  <div>
                    <label for="phone" class="block text-xs font-medium text-neutral-600 mb-2 tracking-wide uppercase">
                      Teléfono
                    </label>
                    <input 
                      id="phone"
                  ...
                  <div>
                    <label for="service" class="block text-xs font-medium text-neutral-600 mb-2 tracking-wide uppercase">
                      Servicio de interés
                    </label>
                ...
                <div>
                  <label for="message" class="block text-xs font-medium text-neutral-600 mb-2 tracking-wide uppercase">
                    Mensaje *
                  </label>
                  <textarea 
                    id="message"
                ...
                <div class="flex items-start">
                  <input 
                    ...
                    type="checkbox"
                    required
                    class="w-4 h-4 text-midnight-800 rounded border-neutral-300 focus:ring-midnight-800 mt-1"
                  />
                  <label for="privacy" class="ml-3 text-xs text-neutral-500 leading-relaxed">
                    He leído y acepto la 
                    <RouterLink to="/privacidad" class="text-midnight-800 hover:text-charcoal-500 underline">política de privacidad</RouterLink>
...
useSeo({
  ...
  description: 'Contacta con ARG Piscinas para solicitar presupuesto, consultas o información sobre nuestros servicios de instalación y rehabilitación de piscinas.',
  keywords: 'contacto piscinas, presupuesto piscinas, consulta piscinas, teléfono ARG Piscinas'
})
